...
2. Cách hoạt động của Policy Routing
...
3. Cach triển khai Policy Routing trên Linux
- Trên hệ điều hành Linux, Policy Routing có thể được triển khai sử dụng các công cụ dòng lệnh như `ip` từ gói `iproute2`.
- Các bước cơ bản để thiết lập Policy Routing trên Linux bao gồm:
  1. Tạo các bảng định tuyến bổ sung trong file `/etc/iproute2/rt_tables`.
  2. Thêm các quy tắc định tuyến chính sách sử dụng lệnh `ip rule add`.
  3. Định nghĩa các tuyến đường trong các bảng định tuyến bổ sung sử dụng lệnh `ip route add`.
# Thêm bảng định tuyến bổ sung
echo "200 custom_table" >> /etc/iproute2/rt_tables
# Thêm quy tắc định tuyến chính sách
ip rule add from
