# PG
## Khái niệm 
- PG (Placement Group) là một nhóm logic dùng để gom các Objects lại với nhau. Thay vì ánh xạ trực tiếp vào Object trong OSD giờ đây Ceph sẽ ánh xạ vào các PG rồi từ PG mới ánh xạ vào OSD
                               Công thức dòng chảy dữ liệu: File -> Objects -> PGs -> OSDs
## Cơ chế hoạt động
...
Bước 1: Object sẽ PG:  Ceph lấy tên Object rồi băm ra thành con số rồi chia lấy dư cho tổng số PG 
                               PG_ID=hash(Object_Name)%Total_PGs
