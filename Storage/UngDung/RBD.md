...
## Cách hoạt động 
- RDB sẽ xé nhỏ dữ liệu của bạn thành các block và phân tán vào các OSD
- Khi một máy linux kết nối tới RDB, chúng sẽ nhìn thấy nó như 1 ổ cứng vật lý cắm trực tiếp `/dev/rdb0` có thể mount format chúng và cài đặt hệ điều hành lên nó
## Đặc điểm kĩ thuật
